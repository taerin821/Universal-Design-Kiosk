          ...
          child: Container(
            ...
            child: Row(
              children: <Widget>[
                ...
                Text('수량', style: TextStyle(fontFamily: 'fifth',color: Colors.black)),
                SizedBox(
                  width: 105.0,
                ),
                Text('가격', style: TextStyle(fontFamily: 'fifth',color: Colors.black)),
              ],
            ),
          ),
        ),
                                    ...
                                    children: [
                                      ...
                                      Expanded(
                                        ...
                                        child: Row(
                                          ...
                                          children: [
                                            Text(
                                              "${burgerCarts[index].price * burgerCarts[index].number}원",
                                              style: TextStyle(
